...
public class TextureLoader {
    ...
    public Texture getErrorTexture() {
    	Texture tex = (Texture) table.get("Error");
    	...
    	try {
    		tex = org.newdawn.slick.opengl.TextureLoader.getTexture("PNG", ResourceLoader.getResourceAsStream(System.getProperty("resources") + "/sprites/Error.png"));
